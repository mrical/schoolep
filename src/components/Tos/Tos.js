...
const Tos = () => {
  ...
  return (
    <CustomModel
      ...
      handleOpen={handleOpenTos}
      title="Terms of Service"
    >
      <Typography variant="h4">Terms of Service</Typography>
      <Typography variant="body1">Last Updated: September 29, 2023</Typography>
      <DialogContent
        sx={{
          overflowY: "auto",
      ...
      >
        <Container>
          ...
          <Typography variant="body1">
            ...
            Service. When creating an account, you agree to provide accurate and
